      ...
      <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        ...
        <div class="statbox widget box box-shadow">
          ...
          <div class="widget-content widget-content-area br-8">
            <table id="daftarpinjam-table" class="table style-2 dt-table-hover">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Nama Member</th>
...
@push('js')
    ...
    $(function () {
          var table = $('#daftarpinjam-table').DataTable({
            ...
            "lengthMenu": [
              ...
              processing: true,
              serverSide: true,
              ajax: "{{ route('data.pinjam.mobil.index') }}",
              columns: [
                  {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: 'false', searchable: 'false', width: '1%'},
                  {data: 'name', name: 'name', title: 'Nama Member', width: '15%'},
                  {data: 'mobil', name: 'mobil', title: 'Mobil', width: '10%'},
                  {data: 'lama', name: 'lama', title: 'Lama Sewa', width: '14%'},
                  {data: 'total', name: 'total', title: 'Tagihan', width: '10%'},
                  {data: 'status_pinjam', name: 'status_pinjam', title: 'Status', width: '10%'},        
...
<script>
                ...
                $('#formAction').on('submit', function(e){
                    ...
                    $.ajax({
                        ...
                        success: function(res){
                            ...
                            $('#daftarpinjam-table').DataTable().ajax.reload();
                            modal.hide()
        ...
        $('#daftarpinjam-table').on('click','.action', function(){
            let data = $(this).data()
            let id = data.id 
            ...
            $.ajax({
                method: 'get',
                url: `{{ url('pinjam-mobil-kembali/') }}/${id}`,
                success: function(res){
