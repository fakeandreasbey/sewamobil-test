...
(function( $, window, document, undefined ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Tak ada data yang tersedia pada tabel ini" )
		{
		...
		if ( ! lang.sLoadingRecords && zeroRecords &&
			defaults.sLoadingRecords === "Memuat..." )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Menampilkan _START_ sampai _END_ dari _TOTAL_ entri
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default Menampilkan 0 sampai 0 dari 0 entri
			 *
			 *  @dtopt Language
